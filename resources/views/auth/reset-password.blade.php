<x-guest-layout>
    ...
    <div class="mb-5 text-center">
        <h1 class="text-xl font-semibold">{{ __('Reset your password') }}</h1>
        <p class="text-sm text-gray-600 mt-1">
            {{ __('Enter your email and new password below to reset access to your account.') }}
        </p>
    </div>
        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-4" novalidate
            ...
            <div>
                ...
                <div x-data="{ show: false }" class="relative" x-cloak
                     x-bind:class="{'shake': sqliTriggered && lastField==='password'}">
            ...
            <div>
                ...
                <div x-data="{ show: false }" class="relative" x-cloak
                     x-bind:class="{'shake': sqliTriggered && lastField==='password_confirmation'}">
